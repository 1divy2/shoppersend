...
export {
  ...
  resolveMotionValue as T,
  resolveVariant as U,
  resolveVariantFromProps as V,
  scrapeMotionValuesFromProps$1 as W,
  scrapeMotionValuesFromProps as X,
  setDragLock as Y,
  setFeatureDefinitions as Z,
  supportsScrollTimeline as _,
